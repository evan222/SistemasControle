...
def calculaOvershoot(set_point,current_value):
    global overshoot, overshootPercentual, antigo_setPoint, flag_overshoot_subida, flag_overshoot
...
def calculaTempoSubida(set_point, current_value, t):
    ...
    if(current_value<set_point and current_value>(set_point-set_point*0.02) and flag_subida):
        tempo_final = t
        tempo_subida = tempo_final - tempo_inicial
        flag_subida = False
    elif(current_value>(set_point*0.02) and flag):
        tempo_inicial=t
        flag=False
...
def calculaTempoAcomodacao(set_point, current_value, t):
    ...
    if((current_value<(set_point-set_point*0.05) or current_value>(set_point+set_point*0.05)) and not(flag_acomodacao)):
        flag_acomodacao = True
        tempo_acomodacao_inicial = 0.0
    if((current_value>(set_point-set_point*0.05) and current_value<(set_point+set_point*0.05)) and abs(t - tempo_acomodacao_inicial)>5.0):
...
class Interface(BoxLayout):
    ...
    def atualiza(self):
        ...
        global flag, flag_subida, flag_acomodacao, flag_overshoot, flag_mudou_setPoint, antigo_setPoint
